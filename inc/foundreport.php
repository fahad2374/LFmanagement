...
$sql = "SELECT * FROM product WHERE (name='$name' OR des = '$des') AND (status='Found' OR status='found') ";
$res = $conn -> query ($sql);
}
...
<div id="wrapper">
    ...
    <div id="page">
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            ...
                            <li><b><a href="foundreport.php">Found Item Report</a></b></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div id="content">
            <div class="contentbg">
                <h2 class="title"><a href="">Found Item Report</a></h2>               
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
  ...
  <button type="submit" name="foundItemsButton">All Found Items</button>
  <input type="submit" name="clear" value="Clear">
  <button type="button" onclick="window.print();return false;">Pdf Report</button>
</form>

<h3><b>Found Item Report</b></h3>
<table class="table table-striped">
 ...
 if(isset($_POST['submit']))
 {
    ...
    $res = []; // Assuming $res is the result set, reset it to an empty array
        ...
        if(isset($_POST['foundItemsButton']))
        {
            $sql_all = "SELECT * FROM product WHERE status='Found'";
