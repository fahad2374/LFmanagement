...
<div id="wrapper">
	...
	<div id="menu-wrapper">
		<ul id="menu">
			...
			<li class="current_page_item"><a href="blog.php"><span>Blog</span></a></li>
	...
	<!-- Default Page Content (contact form) -->
				<div class="post">
					...
					<div class="entry">
						<p>This is <strong>Boldness</strong> v.2, a free, fully standards-compliant CSS template designed by <a href="http://templated.co" rel="nofollow">TEMPLATED</a>.  The picture in this template is from <a href="http://fotogrph.com/"><strong>Fotogrph</strong></a>.The gallery slider and popup gallery used in this template is powered by <strong><a href="#">Poptrox</a></strong> and <strong><a href="http://n33.co/">Slidertron</a></strong>. Dropdown menu is powered by <a href="http://n33.co/"><strong>Dropotron</strong></a>. This free template is released under the <a href="http://templated.co/license">Creative Commons Attribution</a> license, so you’re pretty much free to do whatever you want with it (even use it commercially) provided you give us credit for it. Have fun :)</p>
